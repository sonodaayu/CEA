...
valid_hours = 30 * 24 #fake. Not used.
...
train_list, valid_test_list = train_test(accumulated_consumption_list, train_hours, valid_hours + test_hours)
_, test_list = train_test(valid_test_list, valid_hours, test_hours)
...
with open('SVR_accumulated_results.txt', 'a') as f:
...
plt.plot(range(100), y_test[0:100])
plt.plot(range(100), y_test_pred[0:100])
plt.show()