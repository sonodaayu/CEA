...
print('length of output by attention:', len(test_output_attention))
fig, ax = plt.subplots()
...
# plt.plot(range(100), forecasted_values[plt_from:plt_end], label = 'PVS')\
print('length of output by original PVS:', len(forecasted_values))
plt.plot(range(100), forecasted_values[-101:-1], label = 'Original PVS')
leg = ax.legend()
plt.show()